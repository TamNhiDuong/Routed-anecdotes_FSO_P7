...
describe('the author whose blog posts have the largest amount of likes', () => {
    ...
    const listWithTwoMostLikedAuthors = [
        {
            _id: "5a422a851b54a676234d17f7",
            title: "React patterns",
            author: "Michael Chan",
    ...
    test('when list has two authors writing most blogs', () => {
        const result = listHelper.mostLikes(listWithTwoMostLikedAuthors)
        const expectedResult = { author: 'Edsger W. Dijkstra', likes: 36 }
